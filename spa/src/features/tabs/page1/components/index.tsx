...
export const Page1Component: React.FC = () => {
  ...
  if (!has(Permissions.PAGE1_ACCESS)) {
    return (
      <div style={{ padding: 32 }}>
        <Alert
          ...
          icon={<LockOutlined />}
          message="Ruxsat yo'q"
          description="Bu sahifaga kirish uchun admindan 'Page1 kirish' ruxsatini so'rang."
        />
      </div>
    );
  }
  ...
  const allTabs = [
    { key: Permissions.PAGE1_TAB1, label: 'Tab 1', num: 1 },
    { key: Permissions.PAGE1_TAB2, label: 'Tab 2', num: 2 },
    { key: Permissions.PAGE1_TAB3, label: 'Tab 3', num: 3 },
    { key: Permissions.PAGE1_TAB4, label: 'Tab 4', num: 4 },
    { key: Permissions.PAGE1_TAB5, label: 'Tab 5', num: 5 },
  ];
    ...
    .map(t => ({
      ...
      children: (
        <div style={{ padding: 24 }}>
          <Title level={4}>Page 1 — {t.label}</Title>
